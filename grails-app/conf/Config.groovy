...
grails.plugin.security.stateless.secretKey = System.getenv('EHRSERVER_REST_SECRET')
...
environments {
  ...
  production { // use on server prod environment, https, root = /
    ...
    grails.serverURL = "http://" + System.getenv('OPENSHIFT_APP_DNS') //"https://cabolabs-ehrserver.rhcloud.com/ehr" // comment this if testing prod on localhost
